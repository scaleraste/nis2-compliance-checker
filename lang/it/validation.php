...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il campo :attribute è apparso in una fuga di dati. Si prega di scegliere un :attribute diverso.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Qui è possibile specificare messaggi di validazione personalizzati per gli attributi utilizzando la convenzione "attribute.rule" per nominare le righe.
    | Questo rende veloce la specificazione di un messaggio di linguaggio personalizzato per una determinata regola di attributo.
    |
    */
